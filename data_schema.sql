...
-- =============================================================
-- 14/11/2025 - Tabela e VIEW: Carteira Flat e Último Pedido
-- Objetivo: Criar tabela plana para dados da Carteira e VIEW agregada
--           para melhorar performance nas telas Carteira/Vida
-- =============================================================
...
CREATE OR REPLACE VIEW public.analysis_carteira_last_implant AS
SELECT
...
-- ROLLBACK - Tabela e VIEW Carteira Flat (14/11/2025)
BEGIN;
  DROP VIEW IF EXISTS public.analysis_carteira_last_implant;
  DROP INDEX IF EXISTS public.idx_analysis_carteira_flat_data_implant;
  DROP INDEX IF EXISTS public.idx_analysis_carteira_flat_ferr_key;
  ...
  DROP TABLE IF EXISTS public.analysis_carteira_flat;
COMMIT;
